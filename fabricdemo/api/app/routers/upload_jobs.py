...
def _make_job(
    ...
    step_names: list[str],
    *,
    backend: str = "fabric-gql",
    telemetry_backend: str = "fabric-kql",
    workspace_id: str = "",
    workspace_name: str = "",
) -> dict:
    return {
...
async def _run_upload_job(job_id: str, files: dict[str, Path]):
    ...
    backend = job.get("backend", "fabric-gql")
    telemetry_backend = job.get("telemetry_backend", "fabric-kql")
...
async def create_upload_job(
    ...
    backend: str = Form("fabric-gql"),
    telemetry_backend: str = Form("fabric-kql"),
