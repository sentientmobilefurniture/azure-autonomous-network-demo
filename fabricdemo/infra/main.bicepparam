...
param fabricGraphModelId = readEnvironmentVariable('FABRIC_GRAPH_MODEL_ID', '')
param eventhouseQueryUri = readEnvironmentVariable('EVENTHOUSE_QUERY_URI', '')
param fabricKqlDbName = readEnvironmentVariable('FABRIC_KQL_DB_NAME', '')
