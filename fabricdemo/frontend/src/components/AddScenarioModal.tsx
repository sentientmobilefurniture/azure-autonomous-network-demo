...
export function AddScenarioModal({ open, onClose, onSaved, existingNames, saveScenarioMeta }: Props) {
  ...
  const [selectedBackend, setSelectedBackend] = useState<'fabric-gql'>('fabric-gql');
           ...
           existingNames.includes(name) && (
            <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-3 text-xs">
              ...
              <p className="text-yellow-400/70 mt-1">
                &quot;{name}&quot; already exists. Use a different name to avoid conflicts.
              </p>
              <button
