...
interface ScenarioState {
  ...
  /** Active graph name (e.g. "cloud-outage-topology") */
  activeGraph: string;
  ...
  /** All saved scenarios (single source of truth) */
...
export function ScenarioProvider({ children }: { children: ReactNode }) {
  ...
  // Saved scenarios (single source of truth — eliminates 4x independent fetches)
  ...
  // Whether we've finished validating the persisted scenario against the backend
  ...
  // Clears the ghost if the record was deleted (e.g. after azd up).
