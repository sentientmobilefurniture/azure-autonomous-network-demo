...
FABRIC_WORKSPACE_NAME=${FABRIC_WORKSPACE_NAME:-AutonomousNetworkDemo}
FABRIC_LAKEHOUSE_NAME=${FABRIC_LAKEHOUSE_NAME:-NetworkTopologyLH}
FABRIC_EVENTHOUSE_NAME=${FABRIC_EVENTHOUSE_NAME:-NetworkTelemetryEH_3117}
FABRIC_KQL_DB_DEFAULT=${FABRIC_KQL_DB_DEFAULT:-NetworkDB}
FABRIC_ONTOLOGY_NAME=${FABRIC_ONTOLOGY_NAME:-NetworkTopologyOntology}
...
FABRIC_DATA_AGENT_API_VERSION=${FABRIC_DATA_AGENT_API_VERSION:-2024-05-01-preview}
GRAPH_DATA_AGENT_ID=${GRAPH_DATA_AGENT_ID:-}
TELEMETRY_DATA_AGENT_ID=${TELEMETRY_DATA_AGENT_ID:-}
GRAPH_FABRIC_CONNECTION_NAME=${GRAPH_FABRIC_CONNECTION_NAME:-}
TELEMETRY_FABRIC_CONNECTION_NAME=${TELEMETRY_FABRIC_CONNECTION_NAME:-}
