...
containers. Provides a singleton CosmosClient and CosmosDBManagementClient.

Used by: stores/cosmos_nosql.py, main.py shutdown hook
"""
...
from app.adapters.cosmos_config import COSMOS_NOSQL_ENDPOINT
