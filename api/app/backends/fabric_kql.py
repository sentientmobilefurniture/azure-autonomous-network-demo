...
class FabricKQLBackend:
    ...
    def _get_client(self):
        from app.fabric_discovery import get_fabric_config
    ...
    async def execute_query(self, query: str, **kwargs) -> dict:
        ...
        """
        from app.fabric_discovery import get_fabric_config, is_kql_ready
    ...
    async def ping(self) -> dict:
        ...
        t0 = time.time()
        try:
            from app.fabric_discovery import is_kql_ready, get_fabric_config
            if not is_kql_ready():
